...
#### ![AOEのキャプチャー](https://github.com/dogrunjp/presentation/blob/master/images/stapy-fig-2.png?raw=true)
...
- インタラクティブで直感的な操作が<br>データの切り口発見のインターフェースになるのでは。

---
## AOEでは探索的データ可視化によってこんなことを実現しています
- データ可視化でインタラクティブにデータをフィルターし、データ検索のクエリを生成します。 |
...
---
## データ可視化を<br>Webサービスに取り入れると
- 直感的・逐次的に検索条件を設定でき、キーワード検索とは別の切り口でデータ利用を促進できる。 |
- データ検索以降のプロセスに利用者を誘導することができる。 |
- だろうと考えています。 |

---
## 生命科学のデータベース構築やデータ可視化は今どんな感じ？
- 生命科学は、公共データ利用のデザイン・エンジニアリング的なフロンティアの一つなのでは。
- 効果的なデータ活用のインターフェースのデザイン・実装、試行錯誤が続いています‥
- 多くのデザイナー・エンジニアが生命科学に関心を持って、この分野の課題解決に参加してくれたら良いな、と思っています。
