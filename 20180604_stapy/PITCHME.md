...
---
## データベース活用のためのサービスとしてどんなユースケースを想定する？
-  研究者に登録されたデータをより多く・有効に活用してもらうこと
-　そのため、データの検索・データの取得を容易にするためのインターフェースを提供する

---
## WebサービスのUIとしてData可視化によってできることって何だろう？
1. データベース・データセットの統計指標的な意味を伝える |
1. 探索的（データベースとの双方向的）なデータ検索のインターフェースを提供する |
...
---
## D3.js Barchart with Crossfilter
...
---?image=assets/image/snowscape.jpg&size=auto 80%&color=#2d0630
...
### [Download this template @fa[external-link gp-download]](https://gitpitch.com/template/download/constellation)
